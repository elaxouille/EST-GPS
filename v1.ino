...
GPMS_Application.pde	Date: 23/5/10	Version: 1.01
 ...
 Toutes les données sont envoyées en meme temps sur des adresses differentes.
 Le code va chercher les infos adresse par adresse et les ranger.
 Il attend trois secondes entre chaque frame de la loop
